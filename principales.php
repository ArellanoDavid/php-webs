...
<div class="container">
    <div class="row">
        ...
        $sql = "SELECT * FROM carta where tipo LIKE 'principal'";
        ...
        $sql = "SELECT * FROM carta WHERE tipo LIKE 'principal' LIMIT " . $inicio . "," . $tamanio_pagina;
        ?>
    </div>
</div>
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-sm-4 d-flex align-items-stretch">
                        <div class="card">
                            <img class="card-img-top" src="img/<?= $row['imagen']; ?>" style="width:100%; height:350px; object-fit:cover;">
    ...
    <nav>
        <ul class="pagination justify-content-center">
            ...
            for ($i = 1; $i <= $total_paginas; $i++) {
                ...
                if ($pagina == $i) {
                    echo "<li class='page-item active'><a class='page-link disabled' href='principales.php?pagina=" . $i . "'>" . $i . "</a></li>";
                } else {
                    // Creamos el enlace a cada página sin la clase active.
                    echo "<li class='page-item'><a class='page-link' href='principales.php?pagina=" . $i . "'>" . $i . "</a></li>";
                }
            }
            ?>
        </ul>
