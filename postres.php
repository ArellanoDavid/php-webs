...
<div class="container mt-3">
    <div class="row">
        ...
        $sql = "SELECT * FROM carta where tipo LIKE 'postre'";
        ...
        $sql = "SELECT * FROM carta WHERE tipo LIKE 'postre' LIMIT " . $inicio . "," . $tamanio_pagina;
        ?>
    </div>
</div>
    ...
    <nav>
        <ul class="pagination justify-content-center">
            ...
            for ($i = 1; $i <= $total_paginas; $i++) {
                ...
                if ($pagina == $i) {
                    echo "<li class='page-item active'><a class='page-link disabled' href='postres.php?pagina=" . $i . "'>" . $i . "</a></li>";
                } else {
                    // Creamos el enlace a cada página sin la clase active.
                    echo "<li class='page-item'><a class='page-link' href='postres.php?pagina=" . $i . "'>" . $i . "</a></li>";
                }
            }
            ?>
        </ul>
