...
<head>
  ...
  <link rel="stylesheet" href="css/ligue1.css">
...
<div class="container text-center p-2">
    <div class="row">
  <?php
$sql = "SELECT * FROM equipos where liga='Ligue 1'";
...
if(mysqli_num_rows($resultado)){
  while($fila = mysqli_fetch_assoc($resultado)){ 
      ...
      //imprimir el nombre
      echo '<h4 class="pt-3" style="color:#fff;">'. $fila["nombre"] .'</h4>';
      // Imprimir la imagen del personaje con la etiqueta de la parte superior de la tarjeta
      echo '<img style="color:#fff;" src="login/img/' . $fila['imagen'] . '" class="p-3 img-fluid rounded" alt="' . $fila['nombre'] . '">';
      echo '<div class="anio" style="color:#fff;"><strong>Año Fundación</strong></div>';
      echo '<div class="anio" style="color:#fff;">'.$fila["ano"].'</div>';
      echo '<div class="anio" style="color:#fff;"><strong>Títulos</strong></div>';
      echo '<div class="anio" style="color:#fff;">'.$fila["titulos"].'</div>';
      //enlace a equipo
